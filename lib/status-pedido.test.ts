...
test('pedidoNoFiltroStatus: "em aberto" inclui tudo que não é entregue', () => {
  assert.equal(pedidoNoFiltroStatus('novo', 'em_aberto'), true);
  assert.equal(pedidoNoFiltroStatus('confirmado', 'em_aberto'), true);
  assert.equal(pedidoNoFiltroStatus('preparando', 'em_aberto'), true);
  assert.equal(pedidoNoFiltroStatus('pronto', 'em_aberto'), true);
  assert.equal(pedidoNoFiltroStatus('saiu', 'em_aberto'), true);
  assert.equal(pedidoNoFiltroStatus('entregue', 'em_aberto'), false);
});

test('pedidoNoFiltroStatus: preparando/prontos/entregues nunca se misturam', () => {
  ...
  assert.equal(pedidoNoFiltroStatus('saiu', 'entregues'), false);
});
