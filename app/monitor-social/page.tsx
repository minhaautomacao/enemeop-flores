...
import { Instagram, Facebook, MessageCircle, Users, TrendingUp, Activity, Wifi, WifiOff } from 'lucide-react';
...
const CANAL_CONFIG: Record<string, { label: string; color: string; icon: React.ReactNode; bg: string }> = {
  instagram: { label: 'Instagram', color: '#E1306C', icon: <Instagram className="w-5 h-5" />, bg: 'bg-pink-50 border-pink-200' },
  facebook:  { label: 'Facebook',  color: '#1877F2', icon: <Facebook  className="w-5 h-5" />, bg: 'bg-blue-50 border-blue-200' },
